...
TEST_CASE("ClockTime creators", "[clock-time]") {
    ...
    SECTION("creating from just an hour") {
    ...
    SECTION("creating from an hour and a minute") {
    ...
    SECTION("creating from an hour/minute/second") {
    ...
    SECTION("creating from an hour/minute/second/nanosecond") {
    ...
    SECTION("\"create\" shortcut macro for C functions") {
    ...
    SECTION("creating with decimal seconds") {
    ...
    SECTION("constant creators (midnight, noon)") {
...
TEST_CASE("ClockTime arithmetic operators", "[clock-time]") {
    ...
    SECTION("nanoseconds spilling into seconds") {
    ...
    SECTION("seconds spilling into minutes") {
        c = ClockTime::create(1, 2, 30);
        c += TimeDelta::from_seconds(31);
        IS(1, 3, 1, 0);
    ...
    SECTION("minutes spilling into hours") {
        c = ClockTime::create(3, 40);
        c += TimeDelta::from_minutes(25);
        IS(4, 5, 0, 0);

        c = ClockTime::create(3, 40);
        c -= TimeDelta::from_minutes(45);
        IS(2, 55, 0, 0);
    }

    SECTION("wrap-around of hours") {
